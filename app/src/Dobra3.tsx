                ...
                <div className=' flex flex-col tablet:flex-row tablet:justify-center  tablet:max-w-[90%] gap-4'>
                    ...
                    <div className=" items flex flex-col items-center bg-prim  py-4 rounded-xl max-w-[50%] mx-auto tablet:max-w-[calc(100%/4)]">
                        ...
                        <picture>
                            ...
                            <img src={img1} alt="Empréstimo com Garantia FGTS" width='95%' className=" border-white rounded-lg mx-auto" />
                        </picture>

                        <div className='px-2'>
                            <h3 className="font-bold text-[11px] text-center my-[2em] text-white max-w-[90%] mx-auto desktop:text-2xl desktop:my-4">
                            ...
                            <div className='flex flex-col gap-4 justify-center items-center max-w-[100%] mx-auto'>
                                ...
                                <div className="flex flex-row justify-start items-center gap-2 w-full text-left px-5 text-white desktop:px-2">
                                    <FaHandshake className='min-w-[14px] desktop:min-w-[25px]' />
                                ...
                                <div className="flex flex-row justify-start items-center gap-2 w-full text-left px-5 text-white desktop:px-1">
                                    <MdAttachMoney className='min-w-[14px] desktop:min-w-[30px] desktop:min-h-[25px]' />
                                    <p className="font-normal text-[8px] desktop:text-base">
                                ...
                                <div className="flex flex-row justify-start items-center gap-2 w-full text-left px-5 text-white desktop:px-1">
                                    <FaCalendarAlt className='min-w-[15px] desktop:min-w-[30px]' />
                                    <p className="font-normal text-[8px] desktop:text-base">
                    ...
                    <div className=" items flex flex-col  items-center bg-prim  py-4 rounded-xl max-w-[50%] mx-auto tablet:max-w-[calc(100%/4)]">
                        ...
                        <picture>
                            ...
                            <img src={img2} alt="Crédito Consignado INSS" width='95%' className=" border-white rounded-lg mx-auto" />
                        </picture>
                        ...
                        <div className='px-2'>
                            ...
                            <div className='flex flex-col gap-4 justify-center items-center max-w-[100%] mx-auto'>
                                ...
                                <div className="flex flex-row justify-start items-center gap-2 w-full text-left px-5 text-white desktop:px-3">
                                    <BsSearch className='min-w-[15px] desktop:min-w-[20px] desktop:min-h-[30px]' />
                                    <p className="font-normal text-[8px] desktop:text-base">
                    ...
                    <div className=" items flex flex-col  items-center bg-prim  py-4 rounded-xl max-w-[50%] mx-auto tablet:max-w-[calc(100%/4)]">
                        ...
                        <picture>
                            ...
                            <img src={img3} alt="Crédito Consignado Servidor Publico" width='95%' className=" border-white rounded-lg mx-auto" />
                        </picture>
                        ...
                        <div className='px-2'>
                            ...
                            <div className='flex flex-col gap-4 justify-center items-center max-w-[100%] mx-auto'>
                                ...
                                <div className="flex flex-row justify-start items-center gap-2 w-full text-left px-5 text-white desktop:px-3">
                                    <BsPlusLg className='min-w-[14px] desktop:min-w-[30px] desktop:min-h-[20px]' />
                                    <p className="font-normal text-[8px] desktop:text-base">

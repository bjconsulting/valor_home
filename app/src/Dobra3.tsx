    ...
    return (
        <div className='bg-white px-4 tablet:flex tablet:justify-center tablet:items-center'>
            <div className="flex flex-col gap-4 justify-center items-center pb-10 ">
                ...
                <div className='ALO flex flex-col tablet:flex-row tablet:justify-center  tablet:max-w-[90%]'>
                    ...
                    <div className=" items flex flex-col justify-center items-center bg-prim  py-4 rounded-xl max-w-[50%] mx-auto tablet:max-w-[calc(100%/4)]">
                        ...
                        <div className='px-2'>
                            <h3 className="font-bold text-[11px] text-center my-[2em] text-white max-w-[90%] mx-auto">
                            ...
                            <button className='rounded-xl font-bold flex justify-center items-center text-[13px] px-4 bg-white py-2 mt-6 mx-auto'>
                                Simular agora
                            </button>

        ...
        <>
            <div className="w-full bg-prim">
                <div className="flex justify-center py-8 px-4 gap-4 flex-wrap tablet:gap-6 desktop:max-w-[90%] desktop:mx-auto desktop:py-16">
                    <div className='tablet:w-[calc(95%/4)]'>
                        <img className='w-full' src={mock} alt="MockUp de iPhone" height='auto' />
                    </div>
                    <div className="flex flex-col justify-center w-[calc(100%)] tablet:w-[calc(95%/4)]">
                        <div className="flex flex-col rounded-lg px-3 py-10 bg-white justify-center text-center items-center min-h-[150px] tablet:min-h-[200px] desktop:min-h-[400px] desktop:justify-start desktop:pt-[12%]">
                        ...
                        <button className="rounded-sm font-bold flex justify-center text-center py-3 w-full bg-sub mt-3 text-white tablet:text-[10px] desktop:text-xl hover:text-sub hover:bg-slate-500">
                            Simule seu empréstimo
                        </button>
                    </div>

                    <div className="flex flex-col justify-center w-[calc(100%)] tablet:w-[calc(95%/4)]">
                        <div className="flex flex-col rounded-lg px-3 py-10 bg-white justify-center text-center items-center min-h-[150px] tablet:min-h-[200px] desktop:min-h-[400px] desktop:justify-start desktop:pt-[7%]">
                    ...
                    <div className="flex flex-col justify-center w-[calc(100%)] tablet:w-[calc(95%/4)]">
                        <div className="flex flex-col rounded-lg px-3 py-10 bg-white justify-center text-center items-center min-h-[150px] tablet:min-h-[200px] desktop:min-h-[400px] desktop:justify-start desktop:pt-[15%]">

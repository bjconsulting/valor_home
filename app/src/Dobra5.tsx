...
function Dobra5() {
    return(
        <div className="flex flex-row justify-center items-end gap-4 tablet:gap-[13%] bg-[rgba(217,_217,_217,_.3)] pt-6">
                <picture>
                    <source media="(min-width:640px)" srcSet={itemb} width='200px' />
            ...
            <div className="flex flex-col justify-center items-center gap-6">
                ...
                <button className='rounded-xl bg-prim py-2 px-4 text-white font-bold text-[10px] mb-4'>Fale Conosco</button>
